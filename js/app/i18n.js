...
const EXTRA_PHRASES = [
  ...
  ["Opciones de bus urbano", "Urban bus options"],
  ["Opciones de bus rural", "Rural bus options"],
  ["Selecciona una línea para mostrar su recorrido.", "Select a route to display its path."],
  ["Ver ruta", "View route"],
  ["Cargando ruta", "Loading route"],
  ["Ver otras opciones", "View other options"],
  ["Dirección", "Direction"],
  ["Pronóstico", "Forecast"],
  ["Por hora", "Hourly"],
  ["Por días", "Daily"],
